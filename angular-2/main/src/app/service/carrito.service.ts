...
export class CarritoService {
    pedidoOfertas = [(1,new Oferta("Dark Souls III", "Descuento del 10% en el juego de Dark Souls III", '../img/darSouls.jpg', [new Juego("../img/darSouls.png", "Dark Souls III", "Dark Souls continua redefiniendo los limites con el nuevo y ambicioso capitulo de esta serie revolucionaria, tan aclamada por la critica. ¡Preparate para sumergirte en la oscuridad!", 40.99, 8, ['Dark Fantasy', 'Dificil', 'Atmosferico', 'Rol', 'PvP'], ['PC', 'PS4'])], 0.1, 40.99, 36.99)),

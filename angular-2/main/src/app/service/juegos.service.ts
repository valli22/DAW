...
export class JuegosService{
  ...
  getJuegos(){
    return[
      // imagen - nombre - descripcion - precio - valoracion - tags[string] - plataforma[string]
      new Juego("../img/darSouls.png","Dark Souls III","Dark Souls continua redefiniendo los limites con el nuevo y ambicioso capitulo de esta serie revolucionaria, tan aclamada por la critica. ¡Preparate para sumergirte en la oscuridad!",40.99,8,['Dark Fantasy','Dificil','Atmosferico','Rol','PvP'],['PC','PS4']),
      ...
      new Juego("../img/RatchetyClank.jpg","Ratchet y clank","Esta divertida saga vuelve mas fuerte que nunca. Preparate para las mejores aventuras junto con nuestros queridos amigos Ratchet y Clank.",9,40.99,["Un jugador","Divertido","Historia"],["PS4"]),
      ...
      new Juego("../img/fifa.png","Fifa 16","Uno de los mejores juegos deportivos de soccer. Esta nueva entrega contiene una mejora en aspectos graficos y una mayor realidad.",4,29.40,["Deporte","Soccer","Futbol","2016"],["PS4","XBOX ONE"]),
